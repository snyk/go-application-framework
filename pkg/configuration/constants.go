...
const (
	...
	MACHINE_ID_SOURCE string = "internal_snyk_machine_id_source" // MACHINE_ID_SOURCE (string) returns how MACHINE_ID was resolved: provided, serial, persisted, hostname, generated or ephemeral
