...
//
//	mockgen -source=testapi.go -destination ../mocks/testapi.go -package mocks -imports testapi=github.com/snyk/go-application-framework/pkg/apiclients/testapi
//
...
func (mr *MockTestResultMockRecorder) Findings(ctx any) *gomock.Call {
...
func (mr *MockTestHandleMockRecorder) Wait(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTestClientMockRecorder) StartTest(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
