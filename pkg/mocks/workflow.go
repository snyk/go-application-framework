...
func (m *MockEngine) Invoke(id workflow.Identifier, options ...workflow.InvokeOptions) ([]workflow.Data, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEngineMockRecorder) Invoke(id interface{}, options ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
