...
// GetOutputDestination mocks base method.
func (m *MockInvocationContext) GetOutputDestination() workflow.OutputDestination {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOutputDestination")
	ret0, _ := ret[0].(workflow.OutputDestination)
	return ret0
}

// GetOutputDestination indicates an expected call of GetOutputDestination.
func (mr *MockInvocationContextMockRecorder) GetOutputDestination() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOutputDestination", reflect.TypeOf((*MockInvocationContext)(nil).GetOutputDestination))
}
