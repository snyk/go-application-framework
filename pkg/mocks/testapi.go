...
import (
	...
	testapi "github.com/snyk/go-application-framework/pkg/testapi"
)
...
func (m *MockTestHandle) Result() (testapi.FinalStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Result")
	ret0, _ := ret[0].(testapi.FinalStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTestHandle) Wait(ctx context.Context) (testapi.FinalStatus, error) {
	m.ctrl.T.Helper()
