...
func (e *EngineImpl) Init() error {
	...
	if e.analytics == nil {
		...
		// the analytics endpoint doesn't want authorization information
		e.networkAccess.RemoveHeaderFieldForUrl(e.analytics.GetUrl(), networking.HEADER_FIELD_AUTHORIZATION)
	}
