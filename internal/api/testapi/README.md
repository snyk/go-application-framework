...
- Run `./scripts/pull-down-unified-test-api-spec.sh` to fetch the latest Unified Test OpenAPI spec into <repo>/internal/api/test-api/unified-test-spec/spec.yaml.
