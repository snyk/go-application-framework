// Package unifiedtestapi provides primitives to interact with the openapi HTTP API.
//
...
// Defines values for SnykDeepcodeBundleType.
const (
	SnykDeepcodeBundleTypeSnykDeepcodeBundle SnykDeepcodeBundleType = "snyk_deepcode_bundle"
)

// Defines values for SnykDepGraphType.
const (
	SnykDepGraphTypeSnykDepGraph SnykDepGraphType = "snyk_dep_graph"
)

// Defines values for SnykDepGraphCreateType.
const (
	SnykDepGraphCreateTypeSnykDepGraph SnykDepGraphCreateType = "snyk_dep_graph"
)

// Defines values for SnykGitURLCoordinatesType.
const (
	SnykGitUrlCoordinates SnykGitURLCoordinatesType = "snyk_git_url_coordinates"
)
...
// Defines values for SnykSBOMReachabilityBundlesType.
const (
	SnykSbomReachabilityBundles SnykSBOMReachabilityBundlesType = "snyk_sbom_reachability_bundles"
)
...
// AssetExpr Asset expressions reference the asset that is being tested, and any
// additional references to its contents that may be required in order to test.
type AssetExpr struct {
	union json.RawMessage
}

// AssetExprCreate Asset expressions reference the asset that is being tested, and any
// additional references to its contents that may be required in order to test.
type AssetExprCreate struct {
	union json.RawMessage
}
...
// SnykDeepcodeBundle Asset expression representing source code uploaded to Snyk using DeepCode
// bundle APIs.
type SnykDeepcodeBundle struct {
	...
	// working directory.
	Path string                 `json:"path"`
	Type SnykDeepcodeBundleType `json:"type"`
}

// SnykDeepcodeBundleType defines model for SnykDeepcodeBundle.Type.
type SnykDeepcodeBundleType string

// SnykDepGraph Asset expression representing a Snyk dependency graph (a legacy SBOM format).
type SnykDepGraph struct {
	// AssetId The Asset provides policy context to Test.
	//
	// A common use case is the integration Git SCM repository from which the
	// local copy was cloned and branched. This allows developers to test
	...
	Type        SnykDepGraphType `json:"type"`
}

// SnykDepGraphType defines model for SnykDepGraph.Type.
type SnykDepGraphType string

// SnykDepGraphCreate Asset expression representing a Snyk dependency graph (a legacy SBOM format).
type SnykDepGraphCreate struct {
	// AssetId The Asset provides policy context to Test.
	//
	// A common use case is the integration Git SCM repository from which the
	// local copy was cloned and branched. This allows developers to test
	...
	// Snyk might derive an SBOM from many files.
	SourceFiles []string               `json:"source_files"`
	Type        SnykDepGraphCreateType `json:"type"`
}

// SnykDepGraphCreateType defines model for SnykDepGraphCreate.Type.
type SnykDepGraphCreateType string

// SnykGitURLCoordinates Asset expression representing a source tree located in a Git repository that
// has a Snyk SCM integration.
//
// The SCM integration is used to materialize the source code during the test.
type SnykGitURLCoordinates struct {
	// AssetId The Asset provides policy context to Test.
	//
	// A common use case is the integration Git SCM repository from which the
	// local copy was cloned and branched. This allows developers to test
	...
	Type     SnykGitURLCoordinatesType `json:"type"`
}

// SnykGitURLCoordinatesType defines model for SnykGitURLCoordinates.Type.
type SnykGitURLCoordinatesType string
...
// SnykSBOMReachabilityBundles Asset expression for SBOM test with reachability analysis.
type SnykSBOMReachabilityBundles struct {
	// AssetId The Asset provides policy context to Test.
	//
	// A common use case is the integration Git SCM repository from which the
	// local copy was cloned and branched. This allows developers to test
	...
	Type         SnykSBOMReachabilityBundlesType `json:"type"`
}

// SnykSBOMReachabilityBundlesType defines model for SnykSBOMReachabilityBundles.Type.
type SnykSBOMReachabilityBundlesType string
...
type TestAttributesCreate struct {
	// Asset The asset being tested.
	Asset AssetExprCreate `json:"asset"`
...
// AsSnykDeepcodeBundle returns the union data inside the AssetExpr as a SnykDeepcodeBundle
func (t AssetExpr) AsSnykDeepcodeBundle() (SnykDeepcodeBundle, error) {
	var body SnykDeepcodeBundle
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykDeepcodeBundle overwrites any union data inside the AssetExpr as the provided SnykDeepcodeBundle
func (t *AssetExpr) FromSnykDeepcodeBundle(v SnykDeepcodeBundle) error {
	v.Type = "snyk_deepcode_bundle"
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeSnykDeepcodeBundle performs a merge with any union data inside the AssetExpr, using the provided SnykDeepcodeBundle
func (t *AssetExpr) MergeSnykDeepcodeBundle(v SnykDeepcodeBundle) error {
	v.Type = "snyk_deepcode_bundle"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsSnykDepGraph returns the union data inside the AssetExpr as a SnykDepGraph
func (t AssetExpr) AsSnykDepGraph() (SnykDepGraph, error) {
	var body SnykDepGraph
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykDepGraph overwrites any union data inside the AssetExpr as the provided SnykDepGraph
func (t *AssetExpr) FromSnykDepGraph(v SnykDepGraph) error {
	v.Type = "snyk_dep_graph"
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeSnykDepGraph performs a merge with any union data inside the AssetExpr, using the provided SnykDepGraph
func (t *AssetExpr) MergeSnykDepGraph(v SnykDepGraph) error {
	v.Type = "snyk_dep_graph"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsSnykGitURLCoordinates returns the union data inside the AssetExpr as a SnykGitURLCoordinates
func (t AssetExpr) AsSnykGitURLCoordinates() (SnykGitURLCoordinates, error) {
	var body SnykGitURLCoordinates
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykGitURLCoordinates overwrites any union data inside the AssetExpr as the provided SnykGitURLCoordinates
func (t *AssetExpr) FromSnykGitURLCoordinates(v SnykGitURLCoordinates) error {
	v.Type = "snyk_git_url_coordinates"
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeSnykGitURLCoordinates performs a merge with any union data inside the AssetExpr, using the provided SnykGitURLCoordinates
func (t *AssetExpr) MergeSnykGitURLCoordinates(v SnykGitURLCoordinates) error {
	v.Type = "snyk_git_url_coordinates"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsSnykSBOMReachabilityBundles returns the union data inside the AssetExpr as a SnykSBOMReachabilityBundles
func (t AssetExpr) AsSnykSBOMReachabilityBundles() (SnykSBOMReachabilityBundles, error) {
	var body SnykSBOMReachabilityBundles
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykSBOMReachabilityBundles overwrites any union data inside the AssetExpr as the provided SnykSBOMReachabilityBundles
func (t *AssetExpr) FromSnykSBOMReachabilityBundles(v SnykSBOMReachabilityBundles) error {
	v.Type = "snyk_sbom_reachability_bundles"
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeSnykSBOMReachabilityBundles performs a merge with any union data inside the AssetExpr, using the provided SnykSBOMReachabilityBundles
func (t *AssetExpr) MergeSnykSBOMReachabilityBundles(v SnykSBOMReachabilityBundles) error {
	v.Type = "snyk_sbom_reachability_bundles"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
func (t AssetExpr) Discriminator() (string, error) {
...
func (t AssetExpr) ValueByDiscriminator() (interface{}, error) {
	discriminator, err := t.Discriminator()
	if err != nil {
		return nil, err
	}
	switch discriminator {
	case "snyk_deepcode_bundle":
		return t.AsSnykDeepcodeBundle()
	case "snyk_dep_graph":
		return t.AsSnykDepGraph()
	case "snyk_git_url_coordinates":
		return t.AsSnykGitURLCoordinates()
	case "snyk_sbom_reachability_bundles":
		return t.AsSnykSBOMReachabilityBundles()
	default:
		return nil, errors.New("unknown discriminator value: " + discriminator)
	}
}

func (t AssetExpr) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *AssetExpr) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}

// AsSnykDeepcodeBundle returns the union data inside the AssetExprCreate as a SnykDeepcodeBundle
func (t AssetExprCreate) AsSnykDeepcodeBundle() (SnykDeepcodeBundle, error) {
	var body SnykDeepcodeBundle
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykDeepcodeBundle overwrites any union data inside the AssetExprCreate as the provided SnykDeepcodeBundle
func (t *AssetExprCreate) FromSnykDeepcodeBundle(v SnykDeepcodeBundle) error {
	v.Type = "snyk_deepcode_bundle"
	b, err := json.Marshal(v)
	t.union = b
	return err
...
// MergeSnykDeepcodeBundle performs a merge with any union data inside the AssetExprCreate, using the provided SnykDeepcodeBundle
func (t *AssetExprCreate) MergeSnykDeepcodeBundle(v SnykDeepcodeBundle) error {
	v.Type = "snyk_deepcode_bundle"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsSnykDepGraphCreate returns the union data inside the AssetExprCreate as a SnykDepGraphCreate
func (t AssetExprCreate) AsSnykDepGraphCreate() (SnykDepGraphCreate, error) {
	var body SnykDepGraphCreate
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykDepGraphCreate overwrites any union data inside the AssetExprCreate as the provided SnykDepGraphCreate
func (t *AssetExprCreate) FromSnykDepGraphCreate(v SnykDepGraphCreate) error {
	v.Type = "snyk_dep_graph"
	b, err := json.Marshal(v)
	t.union = b
	return err
...
// MergeSnykDepGraphCreate performs a merge with any union data inside the AssetExprCreate, using the provided SnykDepGraphCreate
func (t *AssetExprCreate) MergeSnykDepGraphCreate(v SnykDepGraphCreate) error {
	v.Type = "snyk_dep_graph"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsSnykGitURLCoordinates returns the union data inside the AssetExprCreate as a SnykGitURLCoordinates
func (t AssetExprCreate) AsSnykGitURLCoordinates() (SnykGitURLCoordinates, error) {
	var body SnykGitURLCoordinates
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykGitURLCoordinates overwrites any union data inside the AssetExprCreate as the provided SnykGitURLCoordinates
func (t *AssetExprCreate) FromSnykGitURLCoordinates(v SnykGitURLCoordinates) error {
	v.Type = "snyk_git_url_coordinates"
	b, err := json.Marshal(v)
	t.union = b
	return err
...
// MergeSnykGitURLCoordinates performs a merge with any union data inside the AssetExprCreate, using the provided SnykGitURLCoordinates
func (t *AssetExprCreate) MergeSnykGitURLCoordinates(v SnykGitURLCoordinates) error {
	v.Type = "snyk_git_url_coordinates"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
// AsSnykSBOMReachabilityBundles returns the union data inside the AssetExprCreate as a SnykSBOMReachabilityBundles
func (t AssetExprCreate) AsSnykSBOMReachabilityBundles() (SnykSBOMReachabilityBundles, error) {
	var body SnykSBOMReachabilityBundles
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSnykSBOMReachabilityBundles overwrites any union data inside the AssetExprCreate as the provided SnykSBOMReachabilityBundles
func (t *AssetExprCreate) FromSnykSBOMReachabilityBundles(v SnykSBOMReachabilityBundles) error {
	v.Type = "snyk_sbom_reachability_bundles"
	b, err := json.Marshal(v)
	t.union = b
	return err
...
// MergeSnykSBOMReachabilityBundles performs a merge with any union data inside the AssetExprCreate, using the provided SnykSBOMReachabilityBundles
func (t *AssetExprCreate) MergeSnykSBOMReachabilityBundles(v SnykSBOMReachabilityBundles) error {
	v.Type = "snyk_sbom_reachability_bundles"
	b, err := json.Marshal(v)
	if err != nil {
		return err
...
func (t AssetExprCreate) Discriminator() (string, error) {
	var discriminator struct {
		Discriminator string `json:"type"`
	}
	err := json.Unmarshal(t.union, &discriminator)
...
func (t AssetExprCreate) ValueByDiscriminator() (interface{}, error) {
	discriminator, err := t.Discriminator()
	if err != nil {
		return nil, err
	}
...
func (t AssetExprCreate) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *AssetExprCreate) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
